              ...
              <Route
                ...
                element={
                  <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-400 via-blue-500 to-blue-600 p-6">
                    <div className="text-center max-w-lg p-8 bg-blue-50/90 backdrop-blur rounded-2xl shadow-xl">
                      <h1 className="text-4xl font-bold text-red-600 mb-4">404 - Page Not Found</h1>
                      <p className="text-blue-700 mb-6">The page you requested does not exist.</p>
                      <NavLink
                        to="/"
